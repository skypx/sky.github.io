非常感谢[磊哥](https://github.com/hoyouly)的细心指导, 同时下面的内容copy自[磊哥](https://github.com/hoyouly/hoyouly.github.io)的Github.在次感谢磊哥的帮助.

//==================================Copy==form==[hoyouly](http://hoyouly.fun)================================//
...
主要修改 `_config.yml` 中的参数和自己的网站小图`favicon.png`
...
url: "http://hoyouly.github.io" # the base hostname & protocol for your site
```
...
google_analytics_id: UA-115937602-1 # google 分析追踪id
```
